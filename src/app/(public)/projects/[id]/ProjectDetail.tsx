        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            <motion.p
              ...
              className="font-display font-light text-ink-mid mb-8"
              style={{ fontSize: "clamp(1.3rem, 2.5vw, 1.8rem)", lineHeight: 1.6 }}
            >
              {project.description}
            </motion.p>
            <motion.p
              ...
              className="font-body text-[#5e5e56] leading-relaxed"
            ...
            <div className="border border-accent/10 p-8 bg-bg-card">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={spec.label} className="flex items-start gap-4 pb-6 border-b border-accent/10 last:border-0 last:pb-0">
                    <span className="text-accent mt-0.5">{spec.icon}</span>
                    <div>
                      <span className="font-body block text-[10px] tracking-[0.25em] uppercase text-[#5e5e56] mb-1">
                        {spec.label}
                      </span>
                      <span
        ...
        <div className="py-24 border-t border-accent/10">
          <div className="max-w-[1400px] mx-auto px-8">
            <div className="flex items-center justify-between mb-16">
              ...
              <Link
                href="/projects"
                className="font-body text-[11px] tracking-[0.3em] uppercase text-accent hover:text-ink transition-colors duration-300"
              >
                Voir tout
              </Link>
            </div>
