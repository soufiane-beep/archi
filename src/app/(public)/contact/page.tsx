        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          >
            ...
            <motion.p
              ...
              className="text-[#666055] text-sm leading-relaxed mb-12"
            ...
            <div className="space-y-8">
              {[
                ...
                >
                  <div className="w-10 h-10 border border-white/10 flex items-center justify-center text-[#c8a97e] shrink-0 mt-0.5">
                    {item.icon}
                  </div>
                  <div>
                    <span
                      className="block text-[10px] tracking-[0.25em] uppercase text-[#3d3a36] mb-1.5"
                      style={{ fontFamily: "var(--font-inter)" }}
                    >
                      {item.label}
                    </span>
                    {item.lines.map((line) =>
                      item.href ? (
                        <a
                          key={line}
                          href={item.href}
                          className="block text-sm text-[#c8c2b8] hover:text-[#c8a97e] transition-colors duration-300"
                          style={{ fontFamily: "var(--font-inter)" }}
                        >
                          {line}
                        </a>
          ...
          <div ref={formRef} className="lg:col-span-8">
            {submitted ? (
              ...
              >
                <div className="w-16 h-16 border border-[#c8a97e]/30 flex items-center justify-center mb-8">
                  <CheckCircle size={28} className="text-[#c8a97e]" />
                </div>
                <h3
                ...
                <p className="text-[#666055] max-w-md" style={{ fontFamily: "var(--font-inter)", fontSize: "0.9rem", lineHeight: 1.7 }}>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-[10px] tracking-[0.25em] uppercase text-[#666055] mb-3" style={{ fontFamily: "var(--font-inter)" }}>
                      Type de Projet
                    </label>
                    <select
                      value={form.type}
                      onChange={(e) => setForm({ ...form, type: e.target.value })}
                      className="w-full bg-[#0d0d0d] border border-white/10 text-[#c8c2b8] px-4 py-3.5 text-sm focus:outline-none focus:border-[#c8a97e] transition-colors duration-300 appearance-none"
                      style={{ fontFamily: "var(--font-inter)" }}
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#0d0d0d] border border-white/10 text-[#c8c2b8] px-4 py-3.5 text-sm focus:outline-none focus:border-[#c8a97e] transition-colors duration-300 resize-none placeholder:text-[#3d3a36]"
                    style={{ fontFamily: "var(--font-inter)" }}
                  />
                </div>

                <div className="flex items-center justify-between">
                  <p className="text-[10px] text-[#3d3a36]" style={{ fontFamily: "var(--font-inter)" }}>
                    * Champs obligatoires
                  </p>
                  <button
                    type="submit"
                    className="group inline-flex items-center gap-4 text-[11px] tracking-[0.3em] uppercase font-medium px-10 py-4 bg-[#c8a97e] text-[#080808] hover:bg-[#dfc49a] transition-colors duration-300"
                    style={{ fontFamily: "var(--font-inter)" }}
                  >
                    Envoyer le Message
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full bg-[#0d0d0d] border border-white/10 text-[#c8c2b8] px-4 py-3.5 text-sm focus:outline-none focus:border-[#c8a97e] transition-colors duration-300 placeholder:text-[#3d3a36]"
        style={{ fontFamily: "var(--font-inter)" }}
      />
    </div>
  );
