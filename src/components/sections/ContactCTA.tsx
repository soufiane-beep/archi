    ...
    <section ref={ref} className="relative py-40 overflow-hidden">
      ...
      <div ref={textRef} className="relative z-10 max-w-[1400px] mx-auto px-8 text-center">
        ...
        <motion.p
          ...
          className="text-[#c8c2b8] max-w-xl mx-auto mb-14 leading-relaxed"
        ...
        >
          <Link
            href="/brief"
            className="group inline-flex items-center gap-3 text-[11px] tracking-[0.3em] uppercase font-medium px-10 py-5 bg-[#c8a97e] text-[#080808] hover:bg-[#dfc49a] transition-colors duration-400"
            style={{ fontFamily: "var(--font-inter)" }}
          >
          ...
          <Link
            href="/projects"
            className="group inline-flex items-center gap-3 text-[11px] tracking-[0.3em] uppercase font-medium px-10 py-5 border border-white/20 text-[#f0ece4] hover:border-white/50 transition-all duration-400"
            style={{ fontFamily: "var(--font-inter)" }}
          >
